...
export const handle_http_get_api_graphql_get = async (options?: RequestInit): Promise<{
    data: unknown;
}> =>{
...
export const handle_http_get_api_graphql_getKey = ()=>{
    return [
        "/api/graphql"
    ] as const;
};
export function useHandle_http_get_api_graphql_get<TData = {
    data: unknown;
}>(options?: {
    query?: Omit<UseQueryOptions<{
        data: unknown;
    ...
    return useQuery({
        queryKey: handle_http_get_api_graphql_getKey(),
        queryFn: ()=>handle_http_get_api_graphql_get(),
        ...options?.query
    });
}
export function useHandle_http_get_api_graphql_getSuspense<TData = {
    data: unknown;
}>(options?: {
    query?: Omit<UseSuspenseQueryOptions<{
        data: unknown;
...
export const handle_http_post_api_graphql_post = async (options?: RequestInit): Promise<{
    data: unknown;
}> =>{
    const res = await fetch("/api/graphql", {
        ...options,
...
export function useHandle_http_post_api_graphql_post(options?: {
    mutation?: UseMutationOptions<{
        data: unknown;
    }, ApiError, void>;
}) {
    return useMutation({
        mutationFn: ()=>handle_http_post_api_graphql_post(),
        ...options?.mutation
    });
}
